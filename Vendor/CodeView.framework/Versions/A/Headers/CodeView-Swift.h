...
SWIFT_CLASS("_TtC8CodeView8CodeView")
@interface CodeView : NSView <MGSDragOperationDelegate, MGSFragariaTextViewDelegate, NSTextDelegate, NSTextViewDelegate>
@property (nonatomic, strong) MGSFragariaView * _Null_unspecified fragariaView;
